namespace NextGen.Models
{
    ...
    public partial class ca_veda_fchk_resp_vchk_report_elect_roll_result_addr_indicator
    {
        [Key]
        public int ca_veda_fchk_resp_vchk_report_elect_roll_result_addr_indicator_id { get; set; }
