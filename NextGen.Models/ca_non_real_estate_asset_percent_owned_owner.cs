namespace NextGen.Models
{
    ...
    public partial class ca_non_real_estate_asset_percent_owned_owner
    {
        [Key]
        public int ca_non_real_estate_asset_percent_owned_owner_id { get; set; }
        ...
        [StringLength(36)]
        public string ed_non_real_estate_asset_external_guid { get; set; }
