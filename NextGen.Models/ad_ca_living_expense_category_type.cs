namespace NextGen.Models
{
    ...
    public partial class ad_ca_living_expense_category_type
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public ad_ca_living_expense_category_type()
        {
            ca_household_living_expense = new HashSet<ca_household_living_expense>();
        }

        [Key]
        public int ad_ca_living_expense_category_type_id { get; set; }
