namespace NextGen.Models
{
    ...
    public partial class ad_ca_tax_depreciation_method_type
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public ad_ca_tax_depreciation_method_type()
        {
            ca_non_real_estate_asset_estimated_value = new HashSet<ca_non_real_estate_asset_estimated_value>();
        }

        [Key]
        public int ad_ca_tax_depreciation_method_type_id { get; set; }
