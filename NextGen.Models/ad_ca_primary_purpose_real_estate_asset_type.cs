namespace NextGen.Models
{
    ...
    public partial class ad_ca_primary_purpose_real_estate_asset_type
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public ad_ca_primary_purpose_real_estate_asset_type()
        {
            ca_real_estate_asset = new HashSet<ca_real_estate_asset>();
        }

        [Key]
        public int ad_ca_primary_purpose_real_estate_asset_type_id { get; set; }
